                ...
                <table class="table table-striped table-bordered" id="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if ($_SESSION['rol'] == 1) { ?>
                            <td>
                                <a href="editar_usuario.php?id=<?php echo $data['idusuario']; ?>"
                                ...
                                <form action="eliminar_usuario.php?id=<?php echo $data['idusuario']; ?>" method="post"
                                    ...
                                    <button onclick="return confirm('Estás seguro que deseas eliminar el registro?');"
                                        class="btn btn-danger" type="submit"><i class='fas fa-trash-alt'></i> </button>
                                </form>
                            </td>
                            <?php } ?>
                        </tr>
